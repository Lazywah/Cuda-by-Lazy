...
__global__ void hammingDistanceGlobal(const char* d_text, const char* d_pattern, unsigned char* d_dist, int L, int lengthText)
{
...
int char_hammingDistance_global(int argc, char** argv)
{
    string inputFile;
    int L = 6;
    int K = 10;
